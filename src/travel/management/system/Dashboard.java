...
public class Dashboard extends JFrame implements ActionListener{
    ...
    JButton addPersonalDetails, viewPersonalDetails,updatePersonalDetails, checkpackages, bookpackage, 
            viewpackage, viewhotels, destinations, bookhotel, viewBookedHotel,payments,calculators,notepad,about,
    ...
    Dashboard(String username){
        ...
        viewpackage= new JButton("Booked Package");
